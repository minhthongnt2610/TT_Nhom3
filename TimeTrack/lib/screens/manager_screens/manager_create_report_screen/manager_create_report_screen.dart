...
class ManagerCreateReportScreen extends StatefulWidget {
  const ManagerCreateReportScreen({super.key, required this.phongBanID});
...
class _ManagerCreateReportScreenState extends State<ManagerCreateReportScreen> {
  ...
  bool _loading = false;
  List<FbBaoCaoPhongBanModel> _baoCao = [];
          ...
          children: [
            ...
            ButtonAdmin(
              ...
              onPressed: () async {
                ...
                final data = await _store.quanLyBaoCaoPhongBan(
                  phongBanId: widget.phongBanID,
            ...
            ButtonAdmin(
              onPressed: () async {
                final file = await excelService.exportBaoCaoPhongBan(_baoCao);
